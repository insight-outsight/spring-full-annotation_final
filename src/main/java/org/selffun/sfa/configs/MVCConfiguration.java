 ...
 *               /> . With @ComponentScan annotation we make sure our @Controller
 *               will be added to the application context. The configuration
 *               class also defines one @Bean: our default view resolver.
 * 
 * */

@Configuration
@EnableWebMvc
//@ComponentScan(basePackages = "org.selffun.**.web")
// @ImportResource({
